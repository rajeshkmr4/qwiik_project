...
Before(async function (scenario) {
  this.scenario = scenario; // Store scenario for step definitions
...
After(async function (scenario) {
  // Clean up menu state for TC_004 scenarios
  ...
  // Don't close context/page for TC003 and TC004 scenarios until all are done
  if (!scenario.pickle.tags.some(tag => tag.name === '@TC003') && 
